...
const BandComponents = () => {
    return (
        <div className={styles.band_components}>
            <BandComponent name="Mario Matobella" picture={marioPicture} type="Bajo eléctrico" social="http://facebook.com/mario" />
            <BandComponent name="Nina Ivanovic" picture={ninaPicture} type="Saxo Barítono" social="" />
            <BandComponent name="Miguel Pinedo" picture={pinPicture} type="Saxo Alto" social="" />
            <BandComponent name="Bruno Stacchiotti" picture={brunoPicture} type="Batería" social="" />
            <BandComponent name="Carlos Aparicio" picture={carlosPicture} type="Teclados" social="" />
        </div>
    )
}
